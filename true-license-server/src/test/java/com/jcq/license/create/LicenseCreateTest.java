...
import com.jcq.license.LicenseCreator;
import com.jcq.license.param.LicenseCheckModel;
import com.jcq.license.param.LicenseCreatorParam;
import com.jcq.util.DateUtil;
...
public class LicenseCreateTest {
    public static void main(String[] args){
        ...
        param.setLicensePath("/Users/lucaju/Documents/workspace/ocr/changzhou-license/ocr.lic");
        param.setPrivateKeysStorePath("/Users/lucaju/Documents/workspace/ocr/changzhou-license/privateKeys.store");
        param.setIssuedTime(DateUtil.parseDate("2025-01-20")); // 起始时间
        param.setExpiryTime(DateUtil.parseDate("9999-02-20")); // 截止时间
        param.setConsumerType("user");
        param.setConsumerAmount(1);
        param.setDescription("这是证书描述信息");
        LicenseCheckModel checkModel = new LicenseCheckModel();
        List<String> macAddressList = new ArrayList<>();
        macAddressList.add("5,6,7,8");
        macAddressList.add("b6:01:fa:0a:0d:f5");
        macAddressList.add("1,2,3,4");
